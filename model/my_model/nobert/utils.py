    ...
    def load_dataset(path,context_pad_size = 300, target_pad_size = 128):
        ...
        with open(path, 'r', encoding='UTF-8') as f:
            ...
            for line in reader:
                ...
                contents.append((context_line, int(label), context_seq_len))
        return contents  # [([...], 0), ([...], 1), ...]
    train = load_dataset(config.train_path, config.context_pad_size)
    dev = load_dataset(config.dev_path, config.context_pad_size)
...
class DatasetIterater(object):
    ...
    def _to_tensor(self, datas):
        if len(datas[0]) == 3:
            ...
            return (context, context_seq_len), label
